...
class Lesson(BaseTable):
	...
	professor: Mapped[User] = mapped_column(String, ForeignKey('user.id', ondelete='CASCADE'), nullable=False)
	student: Mapped[User] = mapped_column(String, ForeignKey('user.id', ondelete='CASCADE'))
